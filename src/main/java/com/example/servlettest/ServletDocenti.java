...
public class ServletDocenti extends HttpServlet {
     ...
     * @throws ServletException
     * @throws IOException
     * Viene invocato un metodo dal DAO che restituisce la lista dei docenti; dopo essere convertita in JSON viene
     * inviata in output.
     */
    @Override
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        ArrayList<Teacher> teachersList = dao.getTeachers();
        Gson gson = new Gson();
        String teachersString = gson.toJson(teachersList);
        out.print(teachersString);
        out.flush();
        out.close();
    }
}
